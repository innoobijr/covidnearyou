var plugins = [{
      plugin: require('/Users/innocentjr/Desktop/sandbox/mit_cddl/covidnearyou/blog/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/Users/innocentjr/Desktop/sandbox/mit_cddl/covidnearyou/blog/node_modules/gatsby-plugin-theme-ui/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/Users/innocentjr/Desktop/sandbox/mit_cddl/covidnearyou/blog/node_modules/gatsby-plugin-feed/gatsby-ssr'),
      options: {"plugins":[],"query":"\n          {\n            site {\n              siteMetadata {\n                title\n                description\n                siteUrl\n                site_url: siteUrl\n              }\n            }\n          }\n        ","feeds":[{"query":"\n              {\n                allArticle(sort: {order: DESC, fields: date}) {\n                  edges {\n                    node {\n                      body\n                      excerpt\n                      date\n                      slug\n                      title\n                      author\n                      secret\n                    }\n                  }\n                }\n              }\n              ","output":"/rss.xml"}]},
    },{
      plugin: require('/Users/innocentjr/Desktop/sandbox/mit_cddl/covidnearyou/blog/node_modules/gatsby-plugin-mdx/gatsby-ssr'),
      ...
      plugin: require('/Users/innocentjr/Desktop/sandbox/mit_cddl/covidnearyou/blog/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
